...
exports.hasColoursSupported = void 0;
...
function hasColoursSupported() {
    ...
    if ('CI' in process.env) {
        return ['GITHUB_ACTIONS', 'TRAVIS', 'CIRCLECI', 'APPVEYOR', 'GITLAB_CI', 'BUILDKITE', 'DRONE'].some(i => i in process.env) || (typeof process.env.CI_NAME !== undefined && process.env.CI_NAME === 'codeship');
    }
...
exports.hasColoursSupported = hasColoursSupported;
